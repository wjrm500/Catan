...
class Chaperone:
    ...
    def set_num_hexagons(self, num_hexagons):
        self.game.num_hexagons = num_hexagons
    ...
    def start_new_game_phase(self):
        self.socket.send('START_NEW_GAME'.encode('utf-8'))
    ...
    def join_existing_game(self, game_code):
        ...
        from_server = self.socket.recv(1024) ### List of connected clients
        self.clients = [from_server] ### Should encode as JSON
    ...
    def start_lobby_phase(self, previous_phase): ### Previous phase could be new game phase or existing game phase
        ...
        self.lobby_phase.clients = self.clients
